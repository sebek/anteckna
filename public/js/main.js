...
new Vue({
    ...
    watch: {
        document: function document(newVal, oldVal) {
    ...
    methods: {
        ...
        insertCharacter: function insertCharacter(character, atPosition, toPosition) {
            this.document = [this.document.slice(0, atPosition), character, this.document.slice(toPosition)].join('');
        },
        removeCharacter: function removeCharacter(atPosition, toPosition) {
        ...
        save: function save() {
            ...
            // Updating
            if (this.documentId) {
                this.documentResource.update({ id: this.documentId }, { name: this.documentName, markdown: this.document }).then(function (response) {}, function (response) {
...
},{"marked":1,"vue":27,"vue-resource":16}]},{},[28]);
